...
- [`cf05f8e`](https://github.com/kondaurovDev/effortless-aws/commit/cf05f8eba2e9b8915aac713806c86712c58c94ae) Thanks [@kondaurovDev](https://github.com/kondaurovDev)! - Add edge protection middleware for static sites, built-in GSI `tag-pk-index` with `queryByTag()`, and type-safe `tagField`
