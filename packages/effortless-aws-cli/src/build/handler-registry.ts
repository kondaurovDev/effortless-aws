...
const RUNTIME_PROPS = ["onRecord", "onBatchComplete", "onBatch", "onMessage", "onObjectCreated", "onObjectRemoved", "setup", "schema", "onError", "onAfterInvoke", "deps", "config", "static", "middleware", "auth", "apiToken", "routes", "get", "post"];
